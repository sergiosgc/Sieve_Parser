 ...
 * [40] <argument>-><tag>
 * [41] <argument>-><string>
 * [42] <string-list>-><square-parenthesis-open><string-plus-csv><square-parenthesis-close>
 ...
 *    +<test>->•<identifier>
 *   --Transitions--
 *    Goto on <test> to 30 because of <command>-><identifier-if>•<test><bracket-open><block>
 *    Goto on <test> to 30 because of <command>-><identifier-if>•<test><bracket-open><block><command-elsif>
 *    Goto on <test> to 30 because of <command>-><identifier-if>•<test><bracket-open><block><command-else>
 *    Shift on <identifier-not> to 31 because of <test>->•<identifier-not><test> Lookahead = 
 *    Shift on <identifier> to 32 because of <test>->•<identifier><arguments> Lookahead = 
 *    Shift on <identifier> to 32 because of <test>->•<identifier> Lookahead = 
 * ----------- 14 -----------
 *   --Itemset--
 *     <command>-><identifier>•<arguments><semicolon>
 *     <command>-><identifier>•<arguments><bracket-open><block>
 ...
 *    +<string>->•<multi-line>
 *   --Transitions--
 *    Goto on <arguments> to 33 because of <command>-><identifier>•<arguments><semicolon>
 *    Goto on <arguments> to 33 because of <command>-><identifier>•<arguments><bracket-open><block>
 *    Shift on <semicolon> to 34 because of <command>-><identifier>•<semicolon> Lookahead = 
 *    Shift on <bracket-open> to 35 because of <command>-><identifier>•<bracket-open><block> Lookahead = 
 *    Goto on <arguments-plus> to 36 because of <arguments>->•<arguments-plus>
 *    Goto on <arguments-plus> to 36 because of <arguments>->•<arguments-plus><test>
 *    Goto on <arguments-plus> to 36 because of <arguments>->•<arguments-plus><test-list>
 *    Goto on <test> to 37 because of <arguments>->•<test>
 *    Goto on <test-list> to 38 because of <arguments>->•<test-list>
 *    Goto on <arguments-plus> to 36 because of <arguments-plus>->•<arguments-plus><argument>
 *    Goto on <argument> to 39 because of <arguments-plus>->•<argument>
 *    Shift on <identifier-not> to 31 because of <test>->•<identifier-not><test> Lookahead = 
 *    Shift on <identifier> to 32 because of <test>->•<identifier><arguments> Lookahead = 
 *    Shift on <identifier> to 32 because of <test>->•<identifier> Lookahead = 
 *    Shift on <parenthesis-open> to 40 because of <test-list>->•<parenthesis-open><test-plus-csv><parenthesis-close> Lookahead = 
 *    Goto on <string-list> to 41 because of <argument>->•<string-list>
 *    Shift on <number> to 42 because of <argument>->•<number> Lookahead = 
 *    Shift on <tag> to 43 because of <argument>->•<tag> Lookahead = 
 *    Goto on <string> to 44 because of <argument>->•<string>
 *    Shift on <square-parenthesis-open> to 29 because of <string-list>->•<square-parenthesis-open><string-plus-csv><square-parenthesis-close> Lookahead = 
 *    Shift on <quoted-string> to 22 because of <string>->•<quoted-string> Lookahead = 
 *    Shift on <multi-line> to 23 because of <string>->•<multi-line> Lookahead = 
 * ----------- 15 -----------
 ...
 *     <argument>-><string>•
 *   --Transitions--
 *    Reduce on <semicolon> using <argument>-><string> Lookahead = 
 *    Reduce on <bracket-open> using <argument>-><string> Lookahead = 
 *    Reduce on <identifier> using <argument>-><string> Lookahead = 
 *    Reduce on <identifier-not> using <argument>-><string> Lookahead = 
 *    Reduce on <parenthesis-open> using <argument>-><string> Lookahead = 
 *    Reduce on <parenthesis-close> using <argument>-><string> Lookahead = 
 *    Reduce on <comma> using <argument>-><string> Lookahead = 
 *    Reduce on <number> using <argument>-><string> Lookahead = 
 *    Reduce on <tag> using <argument>-><string> Lookahead = 
 *    Reduce on <square-parenthesis-open> using <argument>-><string> Lookahead = 
 *    Reduce on <quoted-string> using <argument>-><string> Lookahead = 
 *    Reduce on <multi-line> using <argument>-><string> Lookahead = 
 * ----------- 45 -----------
 *   --Itemset--
 *     <command>-><identifier-notify><string><semicolon>•
 *   --Transitions--
...
class Parser extends \sergiosgc\Text_Parser_LALR
{
     ...
     * @return Text_Tokenizer_Token Result token from reduction. It must be a '<argument>' token
     */
    protected function reduce_rule_41($arg = null)
    {
            $result = isset($tag) ? 
            \sergiosgc\Sieve_Parser\Script_Argument_Tagged::create( $tag->getValue() ) :
            $arg->getValue();
     ...
     */
    protected function reduce_rule_42($strArr = null)
    {
            if (isset($str)) {
            $result = \sergiosgc\Sieve_Parser\Script_Argument_Literal::create( [ $str->getValue() ] );
        } else {
