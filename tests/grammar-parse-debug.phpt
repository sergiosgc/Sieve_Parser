...
-Shifting to state 15

Read token <hash-comment>( Requires
) state [15]
-Reducing using reduce_rule_49 state [15] Result state [5]
-Reducing using reduce_rule_48 state [5] Result state [3]
-Shifting to state 15

Read token <identifier-require>(require) state [3 15]
-Reducing using reduce_rule_49 state [3 15] Result state [3 19]
-Reducing using reduce_rule_47 state [3 19] Result state [3]
-Shifting to state 12

Read token <square-parenthesis-open>( [) state [3 12]
-Shifting to state 29

Read token <quoted-string>(fileinto) state [3 12 29]
-Shifting to state 22

Read token <comma>(,) state [3 12 29 22]
-Reducing using reduce_rule_45 state [3 12 29 22] Result state [3 12 29 50]
-Reducing using reduce_rule_43 state [3 12 29 50] Result state [3 12 29 49]
-Shifting to state 65

Read token <quoted-string>(imap4flags) state [3 12 29 49 65]
-Shifting to state 22

Read token <square-parenthesis-close>(]) state [3 12 29 49 65 22]
-Reducing using reduce_rule_45 state [3 12 29 49 65 22] Result state [3 12 29 49 65 71]
-Reducing using reduce_rule_44 state [3 12 29 49 65 71] Result state [3 12 29 49]
-Shifting to state 64

Read token <semicolon>(;) state [3 12 29 49 64]
-Reducing using reduce_rule_41 state [3 12 29 49 64] Result state [3 12 28]
-Shifting to state 48

Read token <hash-comment>( Whitelist addresses
) state [3 12 28 48]
-Reducing using reduce_rule_11 state [3 12 28 48] Result state [3 18]
-Reducing using reduce_rule_3 state [3 18] Result state [2]
-Reducing using reduce_rule_2 state [2] Result state [1]
-Shifting to state 15

Read token <identifier-if>(if) state [1 15]
-Reducing using reduce_rule_49 state [1 15] Result state [1 5]
-Reducing using reduce_rule_48 state [1 5] Result state [1 3]
-Shifting to state 13

Read token <identifier>(address) state [1 3 13]
-Shifting to state 33

Read token <tag>(all) state [1 3 13 33]
-Shifting to state 44

Read token <tag>(comparator) state [1 3 13 33 44]
-Reducing using reduce_rule_40 state [1 3 13 33 44] Result state [1 3 13 33 40]
-Reducing using reduce_rule_31 state [1 3 13 33 40] Result state [1 3 13 33 37]
-Shifting to state 44

Read token <quoted-string>(i;ascii-casemap) state [1 3 13 33 37 44]
-Reducing using reduce_rule_40 state [1 3 13 33 37 44] Result state [1 3 13 33 37 61]
-Reducing using reduce_rule_30 state [1 3 13 33 37 61] Result state [1 3 13 33 37]
-Shifting to state 22

Read token <tag>(is) state [1 3 13 33 37 22]
-Reducing using reduce_rule_45 state [1 3 13 33 37 22] Result state [1 3 13 33 37 30]
-Reducing using reduce_rule_42 state [1 3 13 33 37 30] Result state [1 3 13 33 37 42]
-Reducing using reduce_rule_38 state [1 3 13 33 37 42] Result state [1 3 13 33 37 61]
-Reducing using reduce_rule_30 state [1 3 13 33 37 61] Result state [1 3 13 33 37]
-Shifting to state 44

Read token <square-parenthesis-open>( [) state [1 3 13 33 37 44]
-Reducing using reduce_rule_40 state [1 3 13 33 37 44] Result state [1 3 13 33 37 61]
-Reducing using reduce_rule_30 state [1 3 13 33 37 61] Result state [1 3 13 33 37]
-Shifting to state 29

Read token <quoted-string>(From) state [1 3 13 33 37 29]
-Shifting to state 22

Read token <comma>(,) state [1 3 13 33 37 29 22]
-Reducing using reduce_rule_45 state [1 3 13 33 37 29 22] Result state [1 3 13 33 37 29 50]
-Reducing using reduce_rule_43 state [1 3 13 33 37 29 50] Result state [1 3 13 33 37 29 49]
-Shifting to state 65

Read token <quoted-string>(Sender) state [1 3 13 33 37 29 49 65]
-Shifting to state 22

Read token <comma>(,) state [1 3 13 33 37 29 49 65 22]
-Reducing using reduce_rule_45 state [1 3 13 33 37 29 49 65 22] Result state [1 3 13 33 37 29 49 65 71]
-Reducing using reduce_rule_44 state [1 3 13 33 37 29 49 65 71] Result state [1 3 13 33 37 29 49]
-Shifting to state 65

Read token <quoted-string>(Resent-From) state [1 3 13 33 37 29 49 65]
-Shifting to state 22

Read token <square-parenthesis-close>(]) state [1 3 13 33 37 29 49 65 22]
-Reducing using reduce_rule_45 state [1 3 13 33 37 29 49 65 22] Result state [1 3 13 33 37 29 49 65 71]
-Reducing using reduce_rule_44 state [1 3 13 33 37 29 49 65 71] Result state [1 3 13 33 37 29 49]
-Shifting to state 64

Read token <square-parenthesis-open>( [) state [1 3 13 33 37 29 49 64]
-Reducing using reduce_rule_41 state [1 3 13 33 37 29 49 64] Result state [1 3 13 33 37 42]
-Reducing using reduce_rule_38 state [1 3 13 33 37 42] Result state [1 3 13 33 37 61]
-Reducing using reduce_rule_30 state [1 3 13 33 37 61] Result state [1 3 13 33 37]
-Shifting to state 29

Read token <quoted-string>(example@gmail.com.example.com) state [1 3 13 33 37 29]
-Shifting to state 22
...
Read token <quoted-string>(example2@gmail.com.example.com) state [1 3 13 33 37 29 49 65]
-Shifting to state 22
...
Read token <bracket-open>( {) state [1 3 13 33 37 29 49 64]
-Reducing using reduce_rule_41 state [1 3 13 33 37 29 49 64] Result state [1 3 13 33 37 42]
-Reducing using reduce_rule_38 state [1 3 13 33 37 42] Result state [1 3 13 33 37 61]
-Reducing using reduce_rule_30 state [1 3 13 33 37 61] Result state [1 3 13 33 37]
-Reducing using reduce_rule_25 state [1 3 13 33 37] Result state [1 3 13 33 53]
-Reducing using reduce_rule_33 state [1 3 13 33 53] Result state [1 3 13 31]
-Shifting to state 51

Read token <identifier-keep>(keep) state [1 3 13 31 51]
-Shifting to state 10

Read token <semicolon>(;) state [1 3 13 31 51 10]
-Shifting to state 26

Read token <identifier-stop>(stop) state [1 3 13 31 51 10 26]
-Reducing using reduce_rule_9 state [1 3 13 31 51 10 26] Result state [1 3 13 31 51 57]
-Shifting to state 6

Read token <semicolon>(;) state [1 3 13 31 51 57 6]
-Shifting to state 20

Read token <bracket-close>(
}) state [1 3 13 31 51 57 6 20]
-Reducing using reduce_rule_5 state [1 3 13 31 51 57 6 20] Result state [1 3 13 31 51 57 57]
-Shifting to state 58

Read token <hash-comment>( Database backup checker
) state [1 3 13 31 51 57 57 58]
-Reducing using reduce_rule_24 state [1 3 13 31 51 57 57 58] Result state [1 3 13 31 51 57 57 68]
-Reducing using reduce_rule_23 state [1 3 13 31 51 57 57 68] Result state [1 3 13 31 51 57 68]
-Reducing using reduce_rule_23 state [1 3 13 31 51 57 68] Result state [1 3 13 31 51 66]
-Reducing using reduce_rule_12 state [1 3 13 31 51 66] Result state [1 3 18]
-Reducing using reduce_rule_3 state [1 3 18] Result state [1 17]
-Reducing using reduce_rule_1 state [1 17] Result state [1]
-Shifting to state 15
...
Read token <identifier-not>(not) state [1 3 13]
-Shifting to state 32

Read token <identifier>(anyof) state [1 3 13 32]
-Shifting to state 33

Read token <parenthesis-open>( () state [1 3 13 32 33]
-Shifting to state 41

Read token <identifier>(header) state [1 3 13 32 33 41]
-Shifting to state 33

Read token <tag>(comparator) state [1 3 13 32 33 41 33]
-Shifting to state 44

Read token <quoted-string>(i;ascii-casemap) state [1 3 13 32 33 41 33 44]
-Reducing using reduce_rule_40 state [1 3 13 32 33 41 33 44] Result state [1 3 13 32 33 41 33 40]
-Reducing using reduce_rule_31 state [1 3 13 32 33 41 33 40] Result state [1 3 13 32 33 41 33 37]
-Shifting to state 22

Read token <tag>(contains) state [1 3 13 32 33 41 33 37 22]
-Reducing using reduce_rule_45 state [1 3 13 32 33 41 33 37 22] Result state [1 3 13 32 33 41 33 37 30]
-Reducing using reduce_rule_42 state [1 3 13 32 33 41 33 37 30] Result state [1 3 13 32 33 41 33 37 42]
-Reducing using reduce_rule_38 state [1 3 13 32 33 41 33 37 42] Result state [1 3 13 32 33 41 33 37 61]
-Reducing using reduce_rule_30 state [1 3 13 32 33 41 33 37 61] Result state [1 3 13 32 33 41 33 37]
-Shifting to state 44

Read token <quoted-string>(Subject) state [1 3 13 32 33 41 33 37 44]
-Reducing using reduce_rule_40 state [1 3 13 32 33 41 33 37 44] Result state [1 3 13 32 33 41 33 37 61]
-Reducing using reduce_rule_30 state [1 3 13 32 33 41 33 37 61] Result state [1 3 13 32 33 41 33 37]
-Shifting to state 22

Read token <quoted-string>(Database backup incomplete) state [1 3 13 32 33 41 33 37 22]
-Reducing using reduce_rule_45 state [1 3 13 32 33 41 33 37 22] Result state [1 3 13 32 33 41 33 37 30]
-Reducing using reduce_rule_42 state [1 3 13 32 33 41 33 37 30] Result state [1 3 13 32 33 41 33 37 42]
-Reducing using reduce_rule_38 state [1 3 13 32 33 41 33 37 42] Result state [1 3 13 32 33 41 33 37 61]
-Reducing using reduce_rule_30 state [1 3 13 32 33 41 33 37 61] Result state [1 3 13 32 33 41 33 37]
...
Read token <comma>(,) state [1 3 13 32 33 41 33 37 22]
-Reducing using reduce_rule_45 state [1 3 13 32 33 41 33 37 22] Result state [1 3 13 32 33 41 33 37 30]
-Reducing using reduce_rule_42 state [1 3 13 32 33 41 33 37 30] Result state [1 3 13 32 33 41 33 37 42]
-Reducing using reduce_rule_38 state [1 3 13 32 33 41 33 37 42] Result state [1 3 13 32 33 41 33 37 61]
-Reducing using reduce_rule_30 state [1 3 13 32 33 41 33 37 61] Result state [1 3 13 32 33 41 33 37]
-Reducing using reduce_rule_25 state [1 3 13 32 33 41 33 37] Result state [1 3 13 32 33 41 33 53]
-Reducing using reduce_rule_33 state [1 3 13 32 33 41 33 53] Result state [1 3 13 32 33 41 63]
-Reducing using reduce_rule_36 state [1 3 13 32 33 41 63] Result state [1 3 13 32 33 41 62]
-Shifting to state 70

Read token <identifier>(header) state [1 3 13 32 33 41 62 70]
-Shifting to state 33

Read token <tag>(comparator) state [1 3 13 32 33 41 62 70 33]
-Shifting to state 44

Read token <quoted-string>(i;ascii-casemap) state [1 3 13 32 33 41 62 70 33 44]
-Reducing using reduce_rule_40 state [1 3 13 32 33 41 62 70 33 44] Result state [1 3 13 32 33 41 62 70 33 40]
-Reducing using reduce_rule_31 state [1 3 13 32 33 41 62 70 33 40] Result state [1 3 13 32 33 41 62 70 33 37]
-Shifting to state 22

Read token <tag>(contains) state [1 3 13 32 33 41 62 70 33 37 22]
-Reducing using reduce_rule_45 state [1 3 13 32 33 41 62 70 33 37 22] Result state [1 3 13 32 33 41 62 70 33 37 30]
-Reducing using reduce_rule_42 state [1 3 13 32 33 41 62 70 33 37 30] Result state [1 3 13 32 33 41 62 70 33 37 42]
-Reducing using reduce_rule_38 state [1 3 13 32 33 41 62 70 33 37 42] Result state [1 3 13 32 33 41 62 70 33 37 61]
-Reducing using reduce_rule_30 state [1 3 13 32 33 41 62 70 33 37 61] Result state [1 3 13 32 33 41 62 70 33 37]
-Shifting to state 44

Read token <quoted-string>(Subject) state [1 3 13 32 33 41 62 70 33 37 44]
-Reducing using reduce_rule_40 state [1 3 13 32 33 41 62 70 33 37 44] Result state [1 3 13 32 33 41 62 70 33 37 61]
-Reducing using reduce_rule_30 state [1 3 13 32 33 41 62 70 33 37 61] Result state [1 3 13 32 33 41 62 70 33 37]
-Shifting to state 22

Read token <quoted-string>(Database backup missing) state [1 3 13 32 33 41 62 70 33 37 22]
-Reducing using reduce_rule_45 state [1 3 13 32 33 41 62 70 33 37 22] Result state [1 3 13 32 33 41 62 70 33 37 30]
-Reducing using reduce_rule_42 state [1 3 13 32 33 41 62 70 33 37 30] Result state [1 3 13 32 33 41 62 70 33 37 42]
-Reducing using reduce_rule_38 state [1 3 13 32 33 41 62 70 33 37 42] Result state [1 3 13 32 33 41 62 70 33 37 61]
-Reducing using reduce_rule_30 state [1 3 13 32 33 41 62 70 33 37 61] Result state [1 3 13 32 33 41 62 70 33 37]
...
Read token <parenthesis-close>( )) state [1 3 13 32 33 41 62 70 33 37 22]
-Reducing using reduce_rule_45 state [1 3 13 32 33 41 62 70 33 37 22] Result state [1 3 13 32 33 41 62 70 33 37 30]
-Reducing using reduce_rule_42 state [1 3 13 32 33 41 62 70 33 37 30] Result state [1 3 13 32 33 41 62 70 33 37 42]
-Reducing using reduce_rule_38 state [1 3 13 32 33 41 62 70 33 37 42] Result state [1 3 13 32 33 41 62 70 33 37 61]
-Reducing using reduce_rule_30 state [1 3 13 32 33 41 62 70 33 37 61] Result state [1 3 13 32 33 41 62 70 33 37]
-Reducing using reduce_rule_25 state [1 3 13 32 33 41 62 70 33 37] Result state [1 3 13 32 33 41 62 70 33 53]
-Reducing using reduce_rule_33 state [1 3 13 32 33 41 62 70 33 53] Result state [1 3 13 32 33 41 62 70 76]
-Reducing using reduce_rule_37 state [1 3 13 32 33 41 62 70 76] Result state [1 3 13 32 33 41 62]
-Shifting to state 69

Read token <bracket-open>( {) state [1 3 13 32 33 41 62 69]
-Reducing using reduce_rule_35 state [1 3 13 32 33 41 62 69] Result state [1 3 13 32 33 39]
-Reducing using reduce_rule_29 state [1 3 13 32 33 39] Result state [1 3 13 32 33 53]
-Reducing using reduce_rule_33 state [1 3 13 32 33 53] Result state [1 3 13 32 52]
-Reducing using reduce_rule_32 state [1 3 13 32 52] Result state [1 3 13 31]
-Shifting to state 51
...
Read token <identifier>(anyof) state [1 3 13]
-Shifting to state 33

Read token <parenthesis-open>( () state [1 3 13 33]
-Shifting to state 41

Read token <identifier>(header) state [1 3 13 33 41]
-Shifting to state 33

Read token <tag>(comparator) state [1 3 13 33 41 33]
-Shifting to state 44

Read token <quoted-string>(i;octet) state [1 3 13 33 41 33 44]
-Reducing using reduce_rule_40 state [1 3 13 33 41 33 44] Result state [1 3 13 33 41 33 40]
-Reducing using reduce_rule_31 state [1 3 13 33 41 33 40] Result state [1 3 13 33 41 33 37]
-Shifting to state 22

Read token <tag>(contains) state [1 3 13 33 41 33 37 22]
-Reducing using reduce_rule_45 state [1 3 13 33 41 33 37 22] Result state [1 3 13 33 41 33 37 30]
-Reducing using reduce_rule_42 state [1 3 13 33 41 33 37 30] Result state [1 3 13 33 41 33 37 42]
-Reducing using reduce_rule_38 state [1 3 13 33 41 33 37 42] Result state [1 3 13 33 41 33 37 61]
-Reducing using reduce_rule_30 state [1 3 13 33 41 33 37 61] Result state [1 3 13 33 41 33 37]
-Shifting to state 44

Read token <quoted-string>(Subject) state [1 3 13 33 41 33 37 44]
-Reducing using reduce_rule_40 state [1 3 13 33 41 33 37 44] Result state [1 3 13 33 41 33 37 61]
-Reducing using reduce_rule_30 state [1 3 13 33 41 33 37 61] Result state [1 3 13 33 41 33 37]
-Shifting to state 22

Read token <quoted-string>(cron) state [1 3 13 33 41 33 37 22]
-Reducing using reduce_rule_45 state [1 3 13 33 41 33 37 22] Result state [1 3 13 33 41 33 37 30]
-Reducing using reduce_rule_42 state [1 3 13 33 41 33 37 30] Result state [1 3 13 33 41 33 37 42]
-Reducing using reduce_rule_38 state [1 3 13 33 41 33 37 42] Result state [1 3 13 33 41 33 37 61]
-Reducing using reduce_rule_30 state [1 3 13 33 41 33 37 61] Result state [1 3 13 33 41 33 37]
...
Read token <comma>(,) state [1 3 13 33 41 33 37 22]
-Reducing using reduce_rule_45 state [1 3 13 33 41 33 37 22] Result state [1 3 13 33 41 33 37 30]
-Reducing using reduce_rule_42 state [1 3 13 33 41 33 37 30] Result state [1 3 13 33 41 33 37 42]
-Reducing using reduce_rule_38 state [1 3 13 33 41 33 37 42] Result state [1 3 13 33 41 33 37 61]
-Reducing using reduce_rule_30 state [1 3 13 33 41 33 37 61] Result state [1 3 13 33 41 33 37]
-Reducing using reduce_rule_25 state [1 3 13 33 41 33 37] Result state [1 3 13 33 41 33 53]
-Reducing using reduce_rule_33 state [1 3 13 33 41 33 53] Result state [1 3 13 33 41 63]
-Reducing using reduce_rule_36 state [1 3 13 33 41 63] Result state [1 3 13 33 41 62]
-Shifting to state 70

Read token <identifier>(header) state [1 3 13 33 41 62 70]
-Shifting to state 33

Read token <tag>(comparator) state [1 3 13 33 41 62 70 33]
-Shifting to state 44

Read token <quoted-string>(i;ascii-casemap) state [1 3 13 33 41 62 70 33 44]
-Reducing using reduce_rule_40 state [1 3 13 33 41 62 70 33 44] Result state [1 3 13 33 41 62 70 33 40]
-Reducing using reduce_rule_31 state [1 3 13 33 41 62 70 33 40] Result state [1 3 13 33 41 62 70 33 37]
-Shifting to state 22

Read token <tag>(is) state [1 3 13 33 41 62 70 33 37 22]
-Reducing using reduce_rule_45 state [1 3 13 33 41 62 70 33 37 22] Result state [1 3 13 33 41 62 70 33 37 30]
-Reducing using reduce_rule_42 state [1 3 13 33 41 62 70 33 37 30] Result state [1 3 13 33 41 62 70 33 37 42]
-Reducing using reduce_rule_38 state [1 3 13 33 41 62 70 33 37 42] Result state [1 3 13 33 41 62 70 33 37 61]
-Reducing using reduce_rule_30 state [1 3 13 33 41 62 70 33 37 61] Result state [1 3 13 33 41 62 70 33 37]
-Shifting to state 44

Read token <quoted-string>(Subject) state [1 3 13 33 41 62 70 33 37 44]
-Reducing using reduce_rule_40 state [1 3 13 33 41 62 70 33 37 44] Result state [1 3 13 33 41 62 70 33 37 61]
-Reducing using reduce_rule_30 state [1 3 13 33 41 62 70 33 37 61] Result state [1 3 13 33 41 62 70 33 37]
-Shifting to state 22

Read token <quoted-string>([sometag] Cron <root@example.com>) state [1 3 13 33 41 62 70 33 37 22]
-Reducing using reduce_rule_45 state [1 3 13 33 41 62 70 33 37 22] Result state [1 3 13 33 41 62 70 33 37 30]
-Reducing using reduce_rule_42 state [1 3 13 33 41 62 70 33 37 30] Result state [1 3 13 33 41 62 70 33 37 42]
-Reducing using reduce_rule_38 state [1 3 13 33 41 62 70 33 37 42] Result state [1 3 13 33 41 62 70 33 37 61]
-Reducing using reduce_rule_30 state [1 3 13 33 41 62 70 33 37 61] Result state [1 3 13 33 41 62 70 33 37]
...
Read token <parenthesis-close>( )) state [1 3 13 33 41 62 70 33 37 22]
-Reducing using reduce_rule_45 state [1 3 13 33 41 62 70 33 37 22] Result state [1 3 13 33 41 62 70 33 37 30]
-Reducing using reduce_rule_42 state [1 3 13 33 41 62 70 33 37 30] Result state [1 3 13 33 41 62 70 33 37 42]
-Reducing using reduce_rule_38 state [1 3 13 33 41 62 70 33 37 42] Result state [1 3 13 33 41 62 70 33 37 61]
-Reducing using reduce_rule_30 state [1 3 13 33 41 62 70 33 37 61] Result state [1 3 13 33 41 62 70 33 37]
-Reducing using reduce_rule_25 state [1 3 13 33 41 62 70 33 37] Result state [1 3 13 33 41 62 70 33 53]
-Reducing using reduce_rule_33 state [1 3 13 33 41 62 70 33 53] Result state [1 3 13 33 41 62 70 76]
-Reducing using reduce_rule_37 state [1 3 13 33 41 62 70 76] Result state [1 3 13 33 41 62]
-Shifting to state 69

Read token <bracket-open>( {) state [1 3 13 33 41 62 69]
-Reducing using reduce_rule_35 state [1 3 13 33 41 62 69] Result state [1 3 13 33 39]
-Reducing using reduce_rule_29 state [1 3 13 33 39] Result state [1 3 13 33 53]
-Reducing using reduce_rule_33 state [1 3 13 33 53] Result state [1 3 13 31]
-Shifting to state 51

Read token <identifier-discard>(discard) state [1 3 13 31 51]
-Shifting to state 11

Read token <semicolon>(;) state [1 3 13 31 51 11]
-Shifting to state 27

Read token <identifier-stop>(stop) state [1 3 13 31 51 11 27]
-Reducing using reduce_rule_10 state [1 3 13 31 51 11 27] Result state [1 3 13 31 51 57]
-Shifting to state 6
...
Read token <identifier>(header) state [1 3 13]
-Shifting to state 33

Read token <tag>(comparator) state [1 3 13 33]
-Shifting to state 44

Read token <quoted-string>(i;ascii-casemap) state [1 3 13 33 44]
-Reducing using reduce_rule_40 state [1 3 13 33 44] Result state [1 3 13 33 40]
-Reducing using reduce_rule_31 state [1 3 13 33 40] Result state [1 3 13 33 37]
-Shifting to state 22

Read token <tag>(contains) state [1 3 13 33 37 22]
-Reducing using reduce_rule_45 state [1 3 13 33 37 22] Result state [1 3 13 33 37 30]
-Reducing using reduce_rule_42 state [1 3 13 33 37 30] Result state [1 3 13 33 37 42]
-Reducing using reduce_rule_38 state [1 3 13 33 37 42] Result state [1 3 13 33 37 61]
-Reducing using reduce_rule_30 state [1 3 13 33 37 61] Result state [1 3 13 33 37]
...
Read token <quoted-string>(Subject) state [1 3 13 33 37 44]
-Reducing using reduce_rule_40 state [1 3 13 33 37 44] Result state [1 3 13 33 37 61]
-Reducing using reduce_rule_30 state [1 3 13 33 37 61] Result state [1 3 13 33 37]
-Shifting to state 22

Read token <quoted-string>([sometag]) state [1 3 13 33 37 22]
-Reducing using reduce_rule_45 state [1 3 13 33 37 22] Result state [1 3 13 33 37 30]
-Reducing using reduce_rule_42 state [1 3 13 33 37 30] Result state [1 3 13 33 37 42]
-Reducing using reduce_rule_38 state [1 3 13 33 37 42] Result state [1 3 13 33 37 61]
-Reducing using reduce_rule_30 state [1 3 13 33 37 61] Result state [1 3 13 33 37]
...
Read token <bracket-open>( {) state [1 3 13 33 37 22]
-Reducing using reduce_rule_45 state [1 3 13 33 37 22] Result state [1 3 13 33 37 30]
-Reducing using reduce_rule_42 state [1 3 13 33 37 30] Result state [1 3 13 33 37 42]
-Reducing using reduce_rule_38 state [1 3 13 33 37 42] Result state [1 3 13 33 37 61]
-Reducing using reduce_rule_30 state [1 3 13 33 37 61] Result state [1 3 13 33 37]
...
Read token <identifier-fileinto>(fileinto) state [1 3 13 31 51]
-Shifting to state 8

Read token <quoted-string>(Servers) state [1 3 13 31 51 8]
-Shifting to state 22

Read token <semicolon>(;) state [1 3 13 31 51 8 22]
-Reducing using reduce_rule_45 state [1 3 13 31 51 8 22] Result state [1 3 13 31 51 8 24]
-Shifting to state 46

Read token <identifier-stop>(stop) state [1 3 13 31 51 8 24 46]
-Reducing using reduce_rule_7 state [1 3 13 31 51 8 24 46] Result state [1 3 13 31 51 57]
-Shifting to state 6
...
Read token <quoted-string>(BLACKLIST - ADDED - 10.0.0.2) state [1 3 13 33 41 33 37 22]
-Reducing using reduce_rule_45 state [1 3 13 33 41 33 37 22] Result state [1 3 13 33 41 33 37 30]
-Reducing using reduce_rule_42 state [1 3 13 33 41 33 37 30] Result state [1 3 13 33 41 33 37 42]
-Reducing using reduce_rule_38 state [1 3 13 33 41 33 37 42] Result state [1 3 13 33 41 33 37 61]
-Reducing using reduce_rule_30 state [1 3 13 33 41 33 37 61] Result state [1 3 13 33 41 33 37]
...
Read token <quoted-string>(i;octet) state [1 3 13 33 41 62 70 33 44]
-Reducing using reduce_rule_40 state [1 3 13 33 41 62 70 33 44] Result state [1 3 13 33 41 62 70 33 40]
-Reducing using reduce_rule_31 state [1 3 13 33 41 62 70 33 40] Result state [1 3 13 33 41 62 70 33 37]
-Shifting to state 22

Read token <tag>(contains) state [1 3 13 33 41 62 70 33 37 22]
-Reducing using reduce_rule_45 state [1 3 13 33 41 62 70 33 37 22] Result state [1 3 13 33 41 62 70 33 37 30]
-Reducing using reduce_rule_42 state [1 3 13 33 41 62 70 33 37 30] Result state [1 3 13 33 41 62 70 33 37 42]
-Reducing using reduce_rule_38 state [1 3 13 33 41 62 70 33 37 42] Result state [1 3 13 33 41 62 70 33 37 61]
-Reducing using reduce_rule_30 state [1 3 13 33 41 62 70 33 37 61] Result state [1 3 13 33 41 62 70 33 37]
...
Read token <quoted-string>(BLACKLIST - REMOVED - 10.0.0.2) state [1 3 13 33 41 62 70 33 37 22]
-Reducing using reduce_rule_45 state [1 3 13 33 41 62 70 33 37 22] Result state [1 3 13 33 41 62 70 33 37 30]
-Reducing using reduce_rule_42 state [1 3 13 33 41 62 70 33 37 30] Result state [1 3 13 33 41 62 70 33 37 42]
-Reducing using reduce_rule_38 state [1 3 13 33 41 62 70 33 37 42] Result state [1 3 13 33 41 62 70 33 37 61]
-Reducing using reduce_rule_30 state [1 3 13 33 41 62 70 33 37 61] Result state [1 3 13 33 41 62 70 33 37]
...
Read token <identifier>(addflag) state [1 3 13 31 51]
-Shifting to state 14

Read token <square-parenthesis-open>( [) state [1 3 13 31 51 14]
-Shifting to state 29

Read token <quoted-string>(\\Seen) state [1 3 13 31 51 14 29]
-Shifting to state 22

Read token <square-parenthesis-close>(]) state [1 3 13 31 51 14 29 22]
-Reducing using reduce_rule_45 state [1 3 13 31 51 14 29 22] Result state [1 3 13 31 51 14 29 50]
-Reducing using reduce_rule_43 state [1 3 13 31 51 14 29 50] Result state [1 3 13 31 51 14 29 49]
-Shifting to state 64

Read token <semicolon>(;) state [1 3 13 31 51 14 29 49 64]
-Reducing using reduce_rule_41 state [1 3 13 31 51 14 29 49 64] Result state [1 3 13 31 51 14 42]
-Reducing using reduce_rule_38 state [1 3 13 31 51 14 42] Result state [1 3 13 31 51 14 40]
-Reducing using reduce_rule_31 state [1 3 13 31 51 14 40] Result state [1 3 13 31 51 14 37]
-Reducing using reduce_rule_25 state [1 3 13 31 51 14 37] Result state [1 3 13 31 51 14 34]
-Shifting to state 54

Read token <identifier-fileinto>(fileinto) state [1 3 13 31 51 14 34 54]
-Reducing using reduce_rule_19 state [1 3 13 31 51 14 34 54] Result state [1 3 13 31 51 57]
-Shifting to state 8

Read token <quoted-string>(Trash) state [1 3 13 31 51 57 8]
-Shifting to state 22

Read token <semicolon>(;) state [1 3 13 31 51 57 8 22]
-Reducing using reduce_rule_45 state [1 3 13 31 51 57 8 22] Result state [1 3 13 31 51 57 8 24]
-Shifting to state 46

Read token <identifier>(removeflag) state [1 3 13 31 51 57 8 24 46]
-Reducing using reduce_rule_7 state [1 3 13 31 51 57 8 24 46] Result state [1 3 13 31 51 57 57]
-Shifting to state 14

Read token <square-parenthesis-open>( [) state [1 3 13 31 51 57 57 14]
-Shifting to state 29

Read token <quoted-string>(\\Seen) state [1 3 13 31 51 57 57 14 29]
-Shifting to state 22

Read token <square-parenthesis-close>(]) state [1 3 13 31 51 57 57 14 29 22]
-Reducing using reduce_rule_45 state [1 3 13 31 51 57 57 14 29 22] Result state [1 3 13 31 51 57 57 14 29 50]
-Reducing using reduce_rule_43 state [1 3 13 31 51 57 57 14 29 50] Result state [1 3 13 31 51 57 57 14 29 49]
-Shifting to state 64

Read token <semicolon>(;) state [1 3 13 31 51 57 57 14 29 49 64]
-Reducing using reduce_rule_41 state [1 3 13 31 51 57 57 14 29 49 64] Result state [1 3 13 31 51 57 57 14 42]
-Reducing using reduce_rule_38 state [1 3 13 31 51 57 57 14 42] Result state [1 3 13 31 51 57 57 14 40]
-Reducing using reduce_rule_31 state [1 3 13 31 51 57 57 14 40] Result state [1 3 13 31 51 57 57 14 37]
-Reducing using reduce_rule_25 state [1 3 13 31 51 57 57 14 37] Result state [1 3 13 31 51 57 57 14 34]
-Shifting to state 54

Read token <identifier-stop>(stop) state [1 3 13 31 51 57 57 14 34 54]
-Reducing using reduce_rule_19 state [1 3 13 31 51 57 57 14 34 54] Result state [1 3 13 31 51 57 57 57]
-Shifting to state 6

Read token <semicolon>(;) state [1 3 13 31 51 57 57 57 6]
-Shifting to state 20

Read token <bracket-close>(
}) state [1 3 13 31 51 57 57 57 6 20]
-Reducing using reduce_rule_5 state [1 3 13 31 51 57 57 57 6 20] Result state [1 3 13 31 51 57 57 57 57]
-Shifting to state 58

Read token <hash-comment>( Google My Business
) state [1 3 13 31 51 57 57 57 57 58]
-Reducing using reduce_rule_24 state [1 3 13 31 51 57 57 57 57 58] Result state [1 3 13 31 51 57 57 57 57 68]
-Reducing using reduce_rule_23 state [1 3 13 31 51 57 57 57 57 68] Result state [1 3 13 31 51 57 57 57 68]
-Reducing using reduce_rule_23 state [1 3 13 31 51 57 57 57 68] Result state [1 3 13 31 51 57 57 68]
-Reducing using reduce_rule_23 state [1 3 13 31 51 57 57 68] Result state [1 3 13 31 51 57 68]
-Reducing using reduce_rule_23 state [1 3 13 31 51 57 68] Result state [1 3 13 31 51 66]
-Reducing using reduce_rule_12 state [1 3 13 31 51 66] Result state [1 3 18]
-Reducing using reduce_rule_3 state [1 3 18] Result state [1 17]
...
Read token <identifier>(allof) state [1 3 13]
-Shifting to state 33

Read token <parenthesis-open>( () state [1 3 13 33]
-Shifting to state 41

Read token <identifier>(address) state [1 3 13 33 41]
-Shifting to state 33

Read token <tag>(all) state [1 3 13 33 41 33]
-Shifting to state 44

Read token <tag>(comparator) state [1 3 13 33 41 33 44]
-Reducing using reduce_rule_40 state [1 3 13 33 41 33 44] Result state [1 3 13 33 41 33 40]
-Reducing using reduce_rule_31 state [1 3 13 33 41 33 40] Result state [1 3 13 33 41 33 37]
-Shifting to state 44

Read token <quoted-string>(i;ascii-casemap) state [1 3 13 33 41 33 37 44]
-Reducing using reduce_rule_40 state [1 3 13 33 41 33 37 44] Result state [1 3 13 33 41 33 37 61]
-Reducing using reduce_rule_30 state [1 3 13 33 41 33 37 61] Result state [1 3 13 33 41 33 37]
-Shifting to state 22

Read token <tag>(is) state [1 3 13 33 41 33 37 22]
-Reducing using reduce_rule_45 state [1 3 13 33 41 33 37 22] Result state [1 3 13 33 41 33 37 30]
-Reducing using reduce_rule_42 state [1 3 13 33 41 33 37 30] Result state [1 3 13 33 41 33 37 42]
-Reducing using reduce_rule_38 state [1 3 13 33 41 33 37 42] Result state [1 3 13 33 41 33 37 61]
-Reducing using reduce_rule_30 state [1 3 13 33 41 33 37 61] Result state [1 3 13 33 41 33 37]
...
Read token <quoted-string>(From) state [1 3 13 33 41 33 37 44]
-Reducing using reduce_rule_40 state [1 3 13 33 41 33 37 44] Result state [1 3 13 33 41 33 37 61]
-Reducing using reduce_rule_30 state [1 3 13 33 41 33 37 61] Result state [1 3 13 33 41 33 37]
-Shifting to state 22

Read token <quoted-string>(googlemybusiness-noreply@google.com) state [1 3 13 33 41 33 37 22]
-Reducing using reduce_rule_45 state [1 3 13 33 41 33 37 22] Result state [1 3 13 33 41 33 37 30]
-Reducing using reduce_rule_42 state [1 3 13 33 41 33 37 30] Result state [1 3 13 33 41 33 37 42]
-Reducing using reduce_rule_38 state [1 3 13 33 41 33 37 42] Result state [1 3 13 33 41 33 37 61]
-Reducing using reduce_rule_30 state [1 3 13 33 41 33 37 61] Result state [1 3 13 33 41 33 37]
...
Read token <identifier>(address) state [1 3 13 33 41 62 70]
-Shifting to state 33

Read token <tag>(all) state [1 3 13 33 41 62 70 33]
-Shifting to state 44

Read token <tag>(comparator) state [1 3 13 33 41 62 70 33 44]
-Reducing using reduce_rule_40 state [1 3 13 33 41 62 70 33 44] Result state [1 3 13 33 41 62 70 33 40]
-Reducing using reduce_rule_31 state [1 3 13 33 41 62 70 33 40] Result state [1 3 13 33 41 62 70 33 37]
-Shifting to state 44

Read token <quoted-string>(i;ascii-casemap) state [1 3 13 33 41 62 70 33 37 44]
-Reducing using reduce_rule_40 state [1 3 13 33 41 62 70 33 37 44] Result state [1 3 13 33 41 62 70 33 37 61]
-Reducing using reduce_rule_30 state [1 3 13 33 41 62 70 33 37 61] Result state [1 3 13 33 41 62 70 33 37]
-Shifting to state 22
...
Read token <quoted-string>(To) state [1 3 13 33 41 62 70 33 37 44]
-Reducing using reduce_rule_40 state [1 3 13 33 41 62 70 33 37 44] Result state [1 3 13 33 41 62 70 33 37 61]
-Reducing using reduce_rule_30 state [1 3 13 33 41 62 70 33 37 61] Result state [1 3 13 33 41 62 70 33 37]
-Shifting to state 22

Read token <quoted-string>(googlemybusiness-noreply@google.com) state [1 3 13 33 41 62 70 33 37 22]
-Reducing using reduce_rule_45 state [1 3 13 33 41 62 70 33 37 22] Result state [1 3 13 33 41 62 70 33 37 30]
-Reducing using reduce_rule_42 state [1 3 13 33 41 62 70 33 37 30] Result state [1 3 13 33 41 62 70 33 37 42]
-Reducing using reduce_rule_38 state [1 3 13 33 41 62 70 33 37 42] Result state [1 3 13 33 41 62 70 33 37 61]
-Reducing using reduce_rule_30 state [1 3 13 33 41 62 70 33 37 61] Result state [1 3 13 33 41 62 70 33 37]
...
Read token <identifier>(false) state [1 3 13 32]
-Shifting to state 33

Read token <bracket-open>( {) state [1 3 13 32 33]
-Reducing using reduce_rule_34 state [1 3 13 32 33] Result state [1 3 13 32 52]
-Reducing using reduce_rule_32 state [1 3 13 32 52] Result state [1 3 13 31]
-Shifting to state 51
...
Read token <bracket-close>(
}) state [1 3 13 31 51 10 26]
-Reducing using reduce_rule_9 state [1 3 13 31 51 10 26] Result state [1 3 13 31 51 57]
-Shifting to state 58

Read token () state [1 3 13 31 51 57 58]
-Reducing using reduce_rule_24 state [1 3 13 31 51 57 58] Result state [1 3 13 31 51 57 68]
-Reducing using reduce_rule_23 state [1 3 13 31 51 57 68] Result state [1 3 13 31 51 66]
-Reducing using reduce_rule_12 state [1 3 13 31 51 66] Result state [1 3 18]
-Reducing using reduce_rule_3 state [1 3 18] Result state [1 17]
-Reducing using reduce_rule_1 state [1 17] Result state [1]
